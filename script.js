...
allChatMessages.push(new ChatMessage("You can use them anywhere for free! Even the customizable profile pictures are free for commercial use.", chatProfiles[3]));
